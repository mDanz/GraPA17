...
{
	m_scene = scene;
	m_cameras[0] = new CameraModel(false, QVector3D(0, -10, 0), QQuaternion::fromAxisAndAngle(0, 0, 1, 0));
	...
	m_cameras[3] = new CameraModel(true, QVector3D(0, 0, -200), QQuaternion::fromAxisAndAngle(1, 0, 0, 90));
